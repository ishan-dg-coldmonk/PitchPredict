...
import com.pitchpredict.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            // Unauthenticated (missing/expired token) → 401 so the frontend can auto-logout.
            // Authenticated-but-forbidden (e.g. USER hitting /api/admin) still returns 403.
