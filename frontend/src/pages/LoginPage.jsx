...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-navy via-navy-light to-navy-lighter flex items-center justify-center p-4">
      ...
      <Link
        to="/"
        className="fixed top-3 sm:top-5 left-3 sm:left-5 z-20 flex items-center gap-1.5 text-xs sm:text-sm text-gray-400 hover:text-white bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl transition-all duration-200"
      >
        <Home size={13} />
      ...
      >
        ...
        <GoogleAuthPanel label="Sign in with Google" />
